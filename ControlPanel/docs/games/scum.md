# Scum — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./scum_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `scum_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/scum/server.cfg` — Main server configuration  
- `~/scum/config/` — Configuration directory
- `~/scum/logs/` — Log files directory
- `~/scum/data/` — Server data and saves
...
- Check official mod repositories or community sites for Scum
