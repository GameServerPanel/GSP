# The Isle — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./the-isle_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `the-isle_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/the-isle/server.cfg` — Main server configuration  
- `~/the-isle/config/` — Configuration directory
- `~/the-isle/logs/` — Log files directory
- `~/the-isle/data/` — Server data and saves
...
- Check official mod repositories or community sites for The Isle
