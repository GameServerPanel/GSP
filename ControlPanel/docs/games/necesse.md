# Necesse — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./necesse_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `necesse_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/necesse/server.cfg` — Main server configuration  
- `~/necesse/config/` — Configuration directory
- `~/necesse/logs/` — Log files directory
- `~/necesse/data/` — Server data and saves
...
- Check official mod repositories or community sites for Necesse
