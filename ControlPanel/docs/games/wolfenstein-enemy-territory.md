# Wolfenstein: Enemy Territory — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./wolfenstein-enemy-territory_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `wolfenstein-enemy-territory_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/wolfenstein-enemy-territory/server.cfg` — Main server configuration  
- `~/wolfenstein-enemy-territory/config/` — Configuration directory
- `~/wolfenstein-enemy-territory/logs/` — Log files directory
- `~/wolfenstein-enemy-territory/data/` — Server data and saves
...
- Check official mod repositories or community sites for Wolfenstein: Enemy Territory
