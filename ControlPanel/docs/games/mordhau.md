# Mordhau — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
MordhauServer.exe -log -Port=7777 -QueryPort=27015
```
...
**Windows:**
- `WindowsServer/Mordhau/Saved/Config/WindowsServer/` — Configuration directory
- `WindowsServer/Mordhau/Saved/Logs/` — Log files
- `WindowsServer/Mordhau/Saved/SaveGames/` — Save files

**Linux:**
- `/home/mordhau/Saved/Config/LinuxServer/` — Configuration directory
- `/home/mordhau/Saved/Logs/` — Log files
- `/home/mordhau/Saved/SaveGames/` — Save files
...
- Check official mod repositories or community sites for Mordhau
