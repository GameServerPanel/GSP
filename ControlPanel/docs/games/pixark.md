# PixARK — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./pixark_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `pixark_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/pixark/server.cfg` — Main server configuration  
- `~/pixark/config/` — Configuration directory
- `~/pixark/logs/` — Log files directory
- `~/pixark/data/` — Server data and saves
...
- Check official mod repositories or community sites for PixARK
