# Tinkertown — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./tinkertown_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `tinkertown_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/tinkertown/server.cfg` — Main server configuration  
- `~/tinkertown/config/` — Configuration directory
- `~/tinkertown/logs/` — Log files directory
- `~/tinkertown/data/` — Server data and saves
...
- Check official mod repositories or community sites for Tinkertown
