# Risk of Rain 2 — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./risk-of-rain-2_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `risk-of-rain-2_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/risk-of-rain-2/server.cfg` — Main server configuration  
- `~/risk-of-rain-2/config/` — Configuration directory
- `~/risk-of-rain-2/logs/` — Log files directory
- `~/risk-of-rain-2/data/` — Server data and saves
...
- Check official mod repositories or community sites for Risk of Rain 2
