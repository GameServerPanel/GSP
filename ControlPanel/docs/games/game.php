...
$slug = preg_replace('/[^a-z0-9\-]/','', strtolower($_GET['g'] ?? ''));
$path = __DIR__ . "/docs/games/{$slug}.md";
...
<div class="toolbar">
  ...
  <a class="btn" href="<?php echo 'docs/games/'.rawurlencode($slug).'.md'; ?>" target="_blank" rel="noopener">View raw Markdown</a>
</div>
<div class="wrap">
  <?php echo $html; ?>
</div>
