# Soulmask — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./soulmask_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `soulmask_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/soulmask/server.cfg` — Main server configuration  
- `~/soulmask/config/` — Configuration directory
- `~/soulmask/logs/` — Log files directory
- `~/soulmask/data/` — Server data and saves
...
- Check official mod repositories or community sites for Soulmask
