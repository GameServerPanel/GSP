# Rem Survival — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./rem-survival_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `rem-survival_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/rem-survival/server.cfg` — Main server configuration  
- `~/rem-survival/config/` — Configuration directory
- `~/rem-survival/logs/` — Log files directory
- `~/rem-survival/data/` — Server data and saves
...
- Check official mod repositories or community sites for Rem Survival
