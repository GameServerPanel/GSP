...
define('OGP_LANG_panel_update_settings', "Panel Update Settings");
define('OGP_LANG_github_update_repository', "GitHub Repository");
define('OGP_LANG_github_update_repository_info', "Enter the GitHub repository in format 'username/repository' to use for updating the panel (e.g., 'Gameservers-World/ControlPanel').");
define('OGP_LANG_github_update_branch', "GitHub Branch");
define('OGP_LANG_github_update_branch_info', "Enter the branch name to use for updating the panel (e.g., 'backup' or 'master').");
define('OGP_LANG_invalid_repository_format', "Invalid repository format");
define('OGP_LANG_expected_format_username_repo', "Expected format: username/repository");
define('OGP_LANG_username_and_repo_required', "Both username and repository name are required");
define('OGP_LANG_invalid_branch_format', "Invalid branch format");
