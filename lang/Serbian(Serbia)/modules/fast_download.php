...
define('LANG_save_as', "Сачувај као");
define('LANG_failure', "Грешка, генерисање алијас фајла није успело");
define('LANG_success', "Успешно");
define('LANG_fast_download_service_for', "Преузимање сервиса за преузимање за %s");
define('LANG_to_the_path', "До путање");
define('LANG_at_url', "на линку");
define('LANG_create_alias_for', "Креирај алијас за");
define('LANG_fast_dl', "Преусмеравање преузимања (Брзо преузимање)");
define('LANG_current_aliases_at_remote_server', "Тренутни алијаси на удаљеном серверу");
define('LANG_delete_selected_aliases', "Избриши изабране алијасе");
define('LANG_no_aliases_defined', "Тренутно нема дефинисаних веб алијаса.");
define('LANG_fastdl_port', "рт");
define('LANG_fastdl_port_info', "Порт на ком ће се Fast Download Daemon стартовати.");
define('LANG_fastdl_ip', "Адресе");
