...
define('LANG_game_server_name_info', "Server navn hjælper brugere til at genkende deres servere.");
...
define('LANG_encryption_key_mismatch', "Krypterings nøgle passer ikke sammen med agenten. Dobbelttjek din konfigurations filer.");
...
define('LANG_game_server', "Spil Server");
...
define('LANG_restore_db_backup', "Genskab DB Backup");
define('LANG_sql_file', "fil(.sql)");
?>