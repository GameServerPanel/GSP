...
<pre><code>%IP% %PORT% %HOSTNAME% %PLAYERS% +map islands %GAMESERVERID% %WHITELIST% %HTTPSERVER%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">+http_startserver</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - +http_startserver</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Enable RCON.</p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-mis_whitelist</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -mis_whitelist</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Whitelisted Only Mode.</p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-mis_gameserverid</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Game Server ID</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Game Server ID</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">100</code></p>
    </div>
</div>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Miscreated server hosting</em>
</p>
