<?php
/**
 * Natural Selection 2 Server Documentation - Comprehensive Guide
...
<h1>Natural Selection 2 Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Natural Selection 2 is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Natural Selection 2 server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">4940</code></li>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Natural Selection 2 server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<p><strong>This game can be installed via SteamCMD using App ID: 4940</strong></p>
...
mkdir -p ~/gameservers/ns2

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/ns2 \
         +app_update 4940 validate \
         +quit

# Server files are now in ~/gameservers/ns2/
cd ~/gameservers/ns2
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\ns2 ^
             +app_update 4940 validate ^
             +quit
</code></pre>
...
<pre><code>%GAME_TYPE% %IP% %PORT% %MAP% %PLAYERS% %HOSTNAME% %HOME_PATH% %BASE_PATH%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        ...
        <p style="color: #e5e7eb; margin: 10px 0;">Will override the server name configured in the panel, leave it blank to use the default name.</p>
    </div>
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        ...
        <p style="color: #e5e7eb; margin: 10px 0;">Specifies a password for clients connecting to the server, leave it blank to remove password protection.</p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-mods</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Mods</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">This should be a list of space separated mod ids that are active on this server, leave it blank for no mods.</p>
    </div>
...
<ul>
    <li>Official Natural Selection 2 documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Natural Selection 2 server hosting</em>
</p>
