# Tower Unite — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./tower-unite_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `tower-unite_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/tower-unite/server.cfg` — Main server configuration  
- `~/tower-unite/config/` — Configuration directory
- `~/tower-unite/logs/` — Log files directory
- `~/tower-unite/data/` — Server data and saves
...
- Check official mod repositories or community sites for Tower Unite
