# Quake 4 — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./quake-4_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `quake-4_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/quake-4/server.cfg` — Main server configuration  
- `~/quake-4/config/` — Configuration directory
- `~/quake-4/logs/` — Log files directory
- `~/quake-4/data/` — Server data and saves
...
- Check official mod repositories or community sites for Quake 4
