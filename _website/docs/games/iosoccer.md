# IOSoccer — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./iosoccer_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `iosoccer_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/iosoccer/server.cfg` — Main server configuration  
- `~/iosoccer/config/` — Configuration directory
- `~/iosoccer/logs/` — Log files directory
- `~/iosoccer/data/` — Server data and saves
...
- Check official mod repositories or community sites for IOSoccer
