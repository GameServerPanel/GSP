# Memories of Mars — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./memories-of-mars_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `memories-of-mars_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/memories-of-mars/server.cfg` — Main server configuration  
- `~/memories-of-mars/config/` — Configuration directory
- `~/memories-of-mars/logs/` — Log files directory
- `~/memories-of-mars/data/` — Server data and saves
...
- Check official mod repositories or community sites for Memories of Mars
