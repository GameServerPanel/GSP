# Quake World — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./quake-world_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `quake-world_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/quake-world/server.cfg` — Main server configuration  
- `~/quake-world/config/` — Configuration directory
- `~/quake-world/logs/` — Log files directory
- `~/quake-world/data/` — Server data and saves
...
- Check official mod repositories or community sites for Quake World
