# Rising World — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./rising-world_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `rising-world_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/rising-world/server.cfg` — Main server configuration  
- `~/rising-world/config/` — Configuration directory
- `~/rising-world/logs/` — Log files directory
- `~/rising-world/data/` — Server data and saves
...
- Check official mod repositories or community sites for Rising World
