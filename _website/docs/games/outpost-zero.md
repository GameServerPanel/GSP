# Outpost Zero — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./outpost-zero_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `outpost-zero_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/outpost-zero/server.cfg` — Main server configuration  
- `~/outpost-zero/config/` — Configuration directory
- `~/outpost-zero/logs/` — Log files directory
- `~/outpost-zero/data/` — Server data and saves
...
- Check official mod repositories or community sites for Outpost Zero
