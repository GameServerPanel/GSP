# Starbound — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./starbound_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `starbound_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/starbound/server.cfg` — Main server configuration  
- `~/starbound/config/` — Configuration directory
- `~/starbound/logs/` — Log files directory
- `~/starbound/data/` — Server data and saves
...
- Check official mod repositories or community sites for Starbound
