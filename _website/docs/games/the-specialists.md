# The Specialists — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./the-specialists_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `the-specialists_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/the-specialists/server.cfg` — Main server configuration  
- `~/the-specialists/config/` — Configuration directory
- `~/the-specialists/logs/` — Log files directory
- `~/the-specialists/data/` — Server data and saves
...
- Check official mod repositories or community sites for The Specialists
