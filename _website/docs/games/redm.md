# RedM — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./redm_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `redm_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/redm/server.cfg` — Main server configuration  
- `~/redm/config/` — Configuration directory
- `~/redm/logs/` — Log files directory
- `~/redm/data/` — Server data and saves
...
- Check official mod repositories or community sites for RedM
