# Path of Titans — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./path-of-titans_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `path-of-titans_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/path-of-titans/server.cfg` — Main server configuration  
- `~/path-of-titans/config/` — Configuration directory
- `~/path-of-titans/logs/` — Log files directory
- `~/path-of-titans/data/` — Server data and saves
...
- Check official mod repositories or community sites for Path of Titans
