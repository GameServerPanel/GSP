# StickyBots — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./stickybots_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `stickybots_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/stickybots/server.cfg` — Main server configuration  
- `~/stickybots/config/` — Configuration directory
- `~/stickybots/logs/` — Log files directory
- `~/stickybots/data/` — Server data and saves
...
- Check official mod repositories or community sites for StickyBots
