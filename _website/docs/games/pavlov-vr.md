# Pavlov VR — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./pavlov-vr_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `pavlov-vr_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/pavlov-vr/server.cfg` — Main server configuration  
- `~/pavlov-vr/config/` — Configuration directory
- `~/pavlov-vr/logs/` — Log files directory
- `~/pavlov-vr/data/` — Server data and saves
...
- Check official mod repositories or community sites for Pavlov VR
