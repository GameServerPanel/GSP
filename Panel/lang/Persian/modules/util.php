...
define('LANG_network_tools', "ابزار شبکه");
define('LANG_sourcemod_admins', "Admin های Sourcemod");
define('LANG_steam_converter', "تبدیل SteamID");
define('LANG_your_ip', "آدرس IP شما:");
...
define('LANG_no_commands', "متاسفانه دستوری برای حساب کاربری شما در دسترس نیست.");
define('LANG_remote_target', "Target IP Address:");
define('LANG_command', "دستور:");
define('LANG_select_agent', "انتخاب Agent:");
