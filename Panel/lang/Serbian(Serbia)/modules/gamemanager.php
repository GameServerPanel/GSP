...
define('LANG_no_games_to_monitor', "Ви немате конфигурисане игре које можете надгледати.");
define('LANG_status', "Статус");
define('LANG_fail_no_mods', "Нема модова омогућених за ову игру! Морате да питате вашег админа да дода мод(ове) за игру додељену вама.");
define('LANG_no_game_homes_assigned', "You don't have any servers assigned to your account.");
define('LANG_select_game_home_to_configure', "Одабери сервер који желите да конфигуришете");
define('LANG_file_manager', "Менаџер датотека");
define('LANG_configure_mods', "Конфигуриши модове");
define('LANG_install_update_steam', "Инсталирај/Ажурирај преко стима");
define('LANG_install_update_manual', "Инсталирај/Ажурирај ручно");
define('LANG_assign_game_homes', "Додели сервере");
define('LANG_user', "Корисник");
define('LANG_group', "Група");
define('LANG_start', "Покрени");
define('LANG_ogp_agent_ip', "OGP Агент IP");
define('LANG_max_players', "Максимално играча");
define('LANG_max', "Максимално");
define('LANG_ip_and_port', "IP и порт");
define('LANG_available_maps', "Доступне мапе");
define('LANG_map_path', "Путања до мапе");
define('LANG_available_parameters', "Доступни параметри");
define('LANG_start_server', "Покрени сервер");
define('LANG_start_wait_note', "Покретање сервера ће можда потрајати. Молимо вас да не затварате претраживач и сачекате.");
define('LANG_game_type', "Тип игре");
define('LANG_map', "Мапа");
define('LANG_starting_server', "Покретање сервера, молимо сачекајте...");
define('LANG_starting_server_settings', "Покретање сервера са следећим подешавањима");
define('LANG_startup_params', "Параметри за покретање");
