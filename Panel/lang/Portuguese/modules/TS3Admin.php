...
define('LANG_title', "TeamSpeak 3 Interface Web");
define('LANG_update_available', "<h3>Atenção: uma nova versão (v%1) deste software está disponível sob <a href=\"%2\" target=\"_blank\">%2</a>.</h3>");
...
define('LANG_vsselect_new_slots', "Slots do cliente");
...
define('LANG_vsoverview_info_general_head', "Configurações Globais");
define('LANG_vsoverview_info_servername', "Nome do servidor");
define('LANG_vsoverview_info_host', "Host/Anfitrião ");
...
define('LANG_vsoverview_info_hostmsg', "Mensagem do host/anfitrião");
...
define('LANG_vsoverview_info_req_securitylvl', "obrigatório");
define('LANG_vsoverview_info_hostbanner_head', "Imagem do Servidor ");
define('LANG_vsoverview_info_hostbanner_url', "URL endereço local/web");
define('LANG_vsoverview_info_hostbanner_imgurl', "Endereço da imagem");
define('LANG_vsoverview_info_hostbanner_buttonurl', "Botão URL do HOST");
