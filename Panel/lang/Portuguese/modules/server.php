...
define('LANG_remote_ips_for', "IPs para servidores de jogos a usar no servidor do agente '%s'");
...
define('LANG_use_nat_info', "Ativar apenas se o seu servidor remoto estiver a usar regras NAT. Use essas configurações se os servidores do seus jogos estiverem a ser executados em endereços IP internos da LAN, para que o painel use um endereço IP remoto real, assim consultar os servidores de jogos.");
