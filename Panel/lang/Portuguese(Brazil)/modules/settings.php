...
define('LANG_panel_name', "Nome Panel");
...
define('LANG_charset_info', "UTF8, ISO, ASCII, etc... Substitui a codificação de caracteres definida nos arquivos de idioma. Deixe em branco para usar o idioma padrão.");
...
define('LANG_old_dashboard_behavior_info', "O painel antigo estava sendo executado mais lentamente, mas mostra mais informações do servidor (por exemplo, jogadores atuais e mapas).");
define('LANG_rsync_available', "Servidores Rsync Disponíveis");
...
define('LANG_recaptcha_site_key', "Chave Recaptcha do site Fornecido pelo Google");
...
define('LANG_welcome_title_info', "Ativa o título exibido na parte superior do painel.");
define('LANG_welcome_title_message', "Bem-vindo a Mensagem de título");
define('LANG_welcome_title_message_info', "A mensagem do título exibida na parte superior do Painel (código HTML permitido).");
define('LANG_logo_link', "Logos Link");
define('LANG_logo_link_info', "O link dos logotipos. <b style='font-size:10px; font-weight:normal;'>(Deixando em branco irá ligá-lo ao painel)</b>");
...
define('LANG_custom_tab_sub', "Sub-Guias Personalizadas");
...
define('LANG_setup_api_authorized_hosts', "Hosts autorizados da API de instalação");
define('LANG_autohorized_hosts', "Hosts autorizados");
define('LANG_add', "Adicionar");
define('LANG_remove', "Remover");
define('LANG_default_trusted_hosts', "Hosts Confiáveis ​​Padrão");
define('LANG_trusted_host_or_proxy_addresses_or_cidr', "Hosts Confiáveis ​​ou Proxies (Endereços IPv4 / IPv6 ou CIDR)");
define('LANG_trusted_forwarded_ip_addresses_or_cidr', "IPs Encaminhados Confiáveis ​​(Endereços IPv4 / IPv6 ou CIDR)");
