...
define('LANG_loading_agents', "Carregando agentes online ...");
define('LANG_loading_failed', "Carregando Agentes falhou.");
...
define('LANG_agent_invalid', "Agente inválido especificado.");
...
define('LANG_amx_login_nick_pass', "Nickname + Senha");
define('LANG_nickname', "Nickname");
define('LANG_amx_mod_perms', "AMX mod X Permissões:");
define('LANG_amx_mod_perm_root', "AMX mod X All Flags.");
define('LANG_amx_mod_perm_custom', "AMX mod X Flags Customizáveis.");
define('LANG_amx_mod_flag_a', "imunidade (não pode ser kicked/baned/slayed/slaped e afetada por outros comandos)");
define('LANG_amx_mod_flag_b', "reservation (pode juntar-se em slots reservados)");
...
define('LANG_amx_mod_flag_g', "amx_cvar command (nem todos os cvars estarão disponíveis)");
define('LANG_amx_mod_flag_h', "amx_cfg command");
define('LANG_amx_mod_flag_i', "amx_chat e outros comandos de chat");
define('LANG_amx_mod_flag_j', "amx_vote e outros comandos de voto");
define('LANG_amx_mod_flag_k', "acesso a cvar sv_password (por comando amx_cvar)");
define('LANG_amx_mod_flag_l', "acesso a cvar amx_rcon command e rcon_password (por comando amx_cvar)");
define('LANG_amx_mod_flag_m', "custom level A (para plugins adicionais)");
