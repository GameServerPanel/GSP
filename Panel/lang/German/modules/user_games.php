...
define('LANG_add_mods_note', "Sie müssen Mods hinzufügen, nachdem Sie dem Benutzer einen Server hinzugefügt haben. Dies kann durch Bearbeiten des Servers erfolgen.");
define('LANG_game_servers', "Spielserver ");
define('LANG_game_path', "Game Pfad");
define('LANG_game_path_info', "Der absolute Server Pfad. Beispiel: /home/ogpbot/OGP_User_Files/My_Server");
define('LANG_game_server_name_info', "Servername hilft Benutzern, ihre Server zu identifizieren. ");
define('LANG_control_password', "Control Passwort");
define('LANG_control_password_info', "Dieses Passwort wird für die Serversteuerung verwendet, z. B. für das RCON-Passwort. Wenn das Passwort leer ist, werden andere Mittel verwendet.");
define('LANG_add_game_home', "Game Server hinzufügen");
define('LANG_game_path_empty', "Game Pfad kann nicht leer sein.");
...
define('LANG_caution_agent_offline_can_not_get_os_and_arch_showing_servers_for_all_platforms', "<b>Achtung!</b> Der Agent ist offline, kann keinen OS-Typ und keine Architektur erhalten, <br>Server für alle Plattformen anzeigen:");
define('LANG_select_remote_server', "Auswählen des Remoteservers");
...
define('LANG_game_configurations', ">Spiele Konfigurationsseite");
define('LANG_add_remote_server', "Server hinzufügen");
define('LANG_wine_games', "Wine Spiele");
define('LANG_home_path', "Home Pfad");
define('LANG_change_home_info', "Der Standort des installierten Spielservers. Beispiel: /home/ogp/my_server/");
...
define('LANG_game_control_password', "Game Control Passwort");
define('LANG_change_control_password_info', "Control password is for example rcon password.");
define('LANG_available_mods', "Verfügbare Mods");
define('LANG_note_no_mods', "No mod(s) available for this game.");
define('LANG_change_home', "Home speichern");
define('LANG_change_control_password', "Control Passwort speichern");
define('LANG_change_name', "Name speichern");
define('LANG_add_mod', "Mod hinzufügen");
define('LANG_set_ip', "IP setzen");
define('LANG_ips_and_ports', "IPs und Ports");
...
define('LANG_cpu_affinity', "CPU-Affinität");
define('LANG_nice_level', "Nice Level");
define('LANG_set_options', "Set Options");
define('LANG_remove_mod', "Mod entfernen");
...
define('LANG_port_range_error', "Der Port muss zwischen 0 und 65535 liegen.");
...
define('LANG_back_to_game_monitor', "Zurück zu Game Monitor");
define('LANG_back_to_game_servers', "Zurück zu Game Server");
define('LANG_user_id_main', "Hauptbesitzer");
define('LANG_change_user_id_main', "Hauptbesitzer speichern");
define('LANG_change_user_id_main_info', "The main server home owner.");
define('LANG_server_ftp_password', "FTP Passwort");
define('LANG_change_ftp_password', "FTP Passwort speichern");
...
define('LANG_ftp_password_can_not_be_changed', "FTP-Passwort kann nicht geändert werden.");
define('LANG_ftp_can_not_be_switched_on', "FTP kann nicht eingeschaltet werden.");
define('LANG_ftp_can_not_be_switched_off', "FTP kann nicht ausgeschaltet werden.");
...
define('LANG_ftp_on', "FTP aktivieren");
define('LANG_ftp_off', "FTP deaktivieren");
define('LANG_change_ftp_account_status', "Status des FTP-Kontos ändern");
...
define('LANG_invalid_path', "Ungültiger Pfad");
define('LANG_add_new_game_home', "Add new game server");
define('LANG_no_game_homes_found', "Keine Game Server gefunden");
define('LANG_available_game_homes', "Verfügbare Game Server");
...
define('LANG_clone', "Duplizieren");
define('LANG_unassign', "Zuweisung aufheben");
define('LANG_access_rights', "Rechte");
define('LANG_assigned_homes', "Derzeit zugewiesene Homes");
define('LANG_assign', "Zuweisen");
...
define('LANG_allow_extra_params', "Zusätzliche Parameter zulassen");
define('LANG_allow_extra_params_info', "Allows user to modify extra command line parameters.");
define('LANG_allow_ftp', "FTP zulassen");
...
define('LANG_note_ips_and_ports_are_not_cloned', "Hinweis - IPs und Ports werden nicht geklont.");
...
define('LANG_failed_to_remove_ftp_account_from_remote_server', "Beseitigen des FTP-Kontos auf dem entfernten Server ist fehlgeschlagen");
define('LANG_remove_it_anyway', "Möchten Sie es trotzdem entfernen?");
define('LANG_sucessfully_deleted', "Erfolgreich gelöscht %s");
...
define('LANG_does_not_exist_yet', "Gibt es noch nicht.");
...
define('LANG_browse', "Durchsuchen");
define('LANG_cancel', "Abbrechen");
define('LANG_set_this_path', "Diesen Pfad festlegen");
...
define('LANG_level_up_info', "Zurück zum vorherigen Ordner.");
define('LANG_add_folder', "Ordner hinzufügen");
