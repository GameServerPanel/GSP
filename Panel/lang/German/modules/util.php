...
define('LANG_module_name', "Dienstprogramme");
define('LANG_ping', "Ping");
define('LANG_traceroute', "Traceroute");
define('LANG_network_tools', "Netzwerk-Tools");
define('LANG_sourcemod_admins', "Sourcemod Admins ");
define('LANG_steam_converter', "SteamID Konverter");
define('LANG_your_ip', "Ihre IP-Adresse:");
define('LANG_loading_agents', "Lade online Agenten...");
define('LANG_loading_failed', "Laden der Agenten fehlgeschlagen.");
define('LANG_agents_offline', "Alle Agenten sind offline.");
define('LANG_no_commands', "Es tut uns leid, Ihr Benutzerkonto hat keine Befehle verfügbar.");
define('LANG_remote_target', "Ziel IP Adresse:");
define('LANG_command', "Befehl:");
define('LANG_select_agent', "Agent auswählen:");
...
define('LANG_command_empty', "Kein Befehl ausgewählt.");
define('LANG_command_unavilable', "The selected command is unavailable on the selected agent.");
define('LANG_target_invalid', "Ungültiger IP/Hostname eingegeben.");
define('LANG_exec_failed', "Zeitüberschreitung beim Warten auf eine Antwort.");
define('LANG_command_no_access', "Du hast keinen Zugriff auf diesen Befehl. Dieser Vorfall wird protokolliert.");
...
define('LANG_command_executed', "Der folgende Befehl wurde erfolgreich gesendet: %s %s");
define('LANG_no_servers', "You have no servers assigned to your account.");
define('LANG_select_server', "Server auswählen:");
define('LANG_select_server_option', "Auswählen...");
define('LANG_steamid', "Steam ID:");
define('LANG_immunity', "Immunität:");
define('LANG_sourcemod_perms', "Sourcemod Rechte:");
define('LANG_sourcemod_perm_root', "Sourcemod Root Flag");
define('LANG_sourcemod_perm_custom', "Sourcemod Benutzerdefinierte Flags");
define('LANG_sourcemod_flag_a', "Reservierter Slot Zugriffe.");
define('LANG_sourcemod_flag_b', "Generic admin; required for admins.");
define('LANG_sourcemod_flag_c', "Kick andere Spieler.");
define('LANG_sourcemod_flag_d', "Bann andere Spieler.");
