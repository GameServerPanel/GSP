...
define('LANG_already_logged_in_redirecting_to_dashboard', "You are already logged in, redirecting to Dashboard.");
define('LANG_logging_in', "Logging in");
define('LANG_redirecting_in', "Redirecting in");
define('LANG_refresh_page', "Refresh Page");
define('LANG_no_rights', "You do not have rights to access this page.");
define('LANG_welcome', "Welcome");
define('LANG_logout', "Logout");
define('LANG_logout_message', "You are now logged out.");
...
define('LANG_lost_passwd', "Forgot your password?");
define('LANG_no_db_connection', "Could not connect to the database.");
define('LANG_bad_login', "Invalid username or password.");
define('LANG_not_logged_in', "You are not currently logged in.");
define('LANG_remove_install', "Please remove install.php file for security reasons.");
define('LANG_agent_offline', "The Agent that is controlling this server is offline.");
define('LANG_logged_in', "You are logged in as");
define('LANG_delete', "Delete");
define('LANG_edit', "Edit");
define('LANG_actions', "Actions");
define('LANG_invalid_subpage', "Invalid subpage.");
...
define('LANG_on', "On");
define('LANG_off', "Off");
define('LANG_db_error_invalid_host', "Invalid database host entered.");
define('LANG_db_error_invalid_user_and_pass', "Invalid database username and/or password.");
define('LANG_db_error_invalid_database', "Invalid database.");
define('LANG_db_unknown_error', "Unkown database error: %s");
define('LANG_db_error_module_missing', "Required PHP database module missing.");
define('LANG_db_error_invalid_db_type', "Invalid database type in config file.");
define('LANG_invalid_login_information', "Invalid login information entered.");
define('LANG_failed_to_read_config', "Failed to read config file.");
define('LANG_account_expired', "Your account has expired.");
define('LANG_contact_admin_to_enable_account', "Contact your administrator to re-enable your account.");
define('LANG_maintenance_mode_on', "Maintenance mode is on");
define('LANG_logging_out_10', "Logging out in 10 seconds");
define('LANG_invalid_redirect', "Redirecting");
define('LANG_login_title', "Control Panel Login");
define('LANG_module_not_installed', "Module is not installed.");
...
define('LANG_gamemanager', "Game Manager");
...
define('LANG_user_cron', "Task Scheduler");
