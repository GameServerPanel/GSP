...
define('LANG_dashboard_ftp_text', "The FTP client can compress files and send them via email, can uncompress too, edit text files and much more.");
...
define('LANG_no_games_to_monitor', "There are currently no online/offline game servers");
define('LANG_online_servers', "Online Servers");
define('LANG_add_games_in', "If you want to add games you can do it in %s");
define('LANG_currently_online', "Currently Online");
