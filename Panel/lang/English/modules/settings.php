...
define('LANG_maintenance_title', "Maintenance Title");
define('LANG_maintenance_title_info', "The title that is displayed to normal users during maintenance.");
define('LANG_maintenance_message', "Maintenance Message");
define('LANG_maintenance_message_info', "The message that is displayed to normal users during maintenance.");
define('LANG_update_settings', "Update Settings");
define('LANG_settings_updated', "Settings successfully updated.");
define('LANG_panel_language', "Panel Language");
define('LANG_panel_language_info', "This language is the default language of the panel. Users can change their own language from their profile editing page.");
define('LANG_page_auto_refresh', "Page Auto Refresh");
...
define('LANG_debug_all', "All (verbose - E_ALL)");
?>
