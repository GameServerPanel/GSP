...
define('LANG_migrate',                          "Migrate");
define('LANG_migrate_server',                   "Migrate Server: %s");
define('LANG_migrate_info',                     "This tool copies all files from the source server to a destination server of the same game type.  The source is never deleted or modified.");
define('LANG_migrate_bullet_no_delete',         "The source server is NOT deleted.");
define('LANG_migrate_bullet_same_game',         "Destination must be the same game type.");
define('LANG_migrate_bullet_overwrite',         "All files in the destination will be overwritten.");
define('LANG_migrate_bullet_no_billing',        "Billing records are not changed automatically.");
define('LANG_migrate_source',                   "Source");
define('LANG_migrate_destination',              "Destination");
define('LANG_migrate_confirm_overwrite',        "Confirm overwrite");
define('LANG_migrate_confirm_overwrite_info',   "Check this box to confirm you want to overwrite the destination server files.");
define('LANG_migrate_start',                    "Start Migration");
define('LANG_migrate_no_compatible_destinations', "No compatible destination servers found (same game type, different server).");
define('LANG_migrate_different_game_type',      "Source and destination must be the same game type.");
define('LANG_migrate_confirm_required',         "You must tick the confirmation checkbox before starting a migration.");
define('LANG_migrate_running_background',       "Migration started and is running in the background.");
define('LANG_migrate_complete',                 "Migration completed successfully.");
define('LANG_migrate_failed_code',              "Migration failed with return code %d.");
?>