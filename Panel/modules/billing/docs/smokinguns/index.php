<?php
/**
 * Smokin Guns Server Documentation - Comprehensive Guide
...
<h1>Smokin Guns Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Smokin Guns is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Smokin Guns server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Smokin Guns server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<pre><code>server +set dedicated 2 +exec server.cfg +set ttycon 0 %IP% %PORT% %PLAYERS%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        ...
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">gametype 0 +exec server_deathmatch.cfg</code> - Death Match</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">gametype 1 +exec server_duel.cfg</code> - Duel</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">gametype 3 +exec server_deathmatch.cfg</code> - Team Death Match</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">gametype 4 +exec server_mixed.cfg</code> - Round Teamplay</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">gametype 5 +exec server_bank_robbery.cfg</code> - Bank Robbery</li>
        </ul>
    </div>
</div>
...
<ul>
    <li>Official Smokin Guns documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Smokin Guns server hosting</em>
</p>
