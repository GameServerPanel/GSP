<?php
/**
 * Urban Terror 4 Server Documentation - Comprehensive Guide
...
<h1>Urban Terror 4 Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Urban Terror 4 is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Urban Terror 4 server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">405100</code></li>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Urban Terror 4 server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
# Windows Firewall
netsh advfirewall firewall add rule name="Urban Terror 4 Server" dir=in action=allow protocol=TCP localport=[PORT]
netsh advfirewall firewall add rule name="Urban Terror 4 Server" dir=in action=allow protocol=UDP localport=[PORT]
</code></pre>
...
<p><strong>This game can be installed via SteamCMD using App ID: 405100</strong></p>
...
mkdir -p ~/gameservers/urt

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/urt \
         +app_update 405100 validate \
         +quit

# Server files are now in ~/gameservers/urt/
cd ~/gameservers/urt
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\urt ^
             +app_update 405100 validate ^
             +quit
</code></pre>
...
[Unit]
Description=Urban Terror 4 Server
...
<ul>
    <li>Official Urban Terror 4 documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Urban Terror 4 server hosting</em>
</p>
