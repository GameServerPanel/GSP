<?php
/**
 * Homefront Server Documentation - Comprehensive Guide
...
<h1>Homefront Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Homefront is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Homefront server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">55280</code></li>
...
<p><strong>This game can be installed via SteamCMD using App ID: 55280</strong></p>
...
<pre><code>SERVER %PLAYERS% %IP% %PORT% %STEAM_PORT% %RCON1_PORT% %RCON2_PORT% -configsubdir=DedicatedProfile_DefaultProfile</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-authport=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -authport=</span>
        </h4>
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-rconport1=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -rconport1=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">The RCON port for remote admin connections.</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">27010</code></p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-rconport2=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -rconport2=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">The RCON port for remote admin connections.</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">27011</code></p>
    </div>
</div>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Homefront server hosting</em>
</p>
