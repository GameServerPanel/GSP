<?php
/**
 * TrackMania Nations Forever Server Documentation - Comprehensive Guide
...
<h1>TrackMania Nations Forever Server Hosting Guide</h1>

<h2>Overview</h2>
<p>TrackMania Nations Forever is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a TrackMania Nations Forever server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The TrackMania Nations Forever server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<pre><code>%MS% /dedicated_cfg=dedicated_cfg.txt %HOSTNAME%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">/game_settings=MatchSettings/Nations/</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - /game_settings=MatchSettings/Nations/</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Set the match settings file (default files are NationsWhite.txt, NationsGreen.txt, NationsBlue.txt and NationsRed.txt).</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">NationsWhite.txt</code></p>
    </div>
</div>
...
<ul>
    <li>Official TrackMania Nations Forever documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For TrackMania Nations Forever server hosting</em>
</p>
