<?php
/**
 * Hidden: Source Server Documentation - Comprehensive Guide
...
<h1>Hidden: Source Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Hidden: Source is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Hidden: Source server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            ...
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Disable SourceTV</span>
        </h4>
