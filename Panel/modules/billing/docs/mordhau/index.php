<?php
/**
 * Mordhau Server Documentation - Comprehensive Guide
...
<h1>Mordhau Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Mordhau is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Mordhau server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">629760</code></li>
        ...
        <li><strong style="color: #ffffff;">Configuration Files:</strong><ul style="margin-top: 8px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Mordhau/Saved/Config/LinuxServer/Game.ini</code> - Main Config File</li>
        </ul></li>
    </ul>
</div>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Mordhau server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<p><strong>This game can be installed via SteamCMD using App ID: 629760</strong></p>
...
mkdir -p ~/gameservers/mordhau

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/mordhau \
         +app_update 629760 validate \
         +quit

# Server files are now in ~/gameservers/mordhau/
cd ~/gameservers/mordhau
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\mordhau ^
             +app_update 629760 validate ^
             +quit
</code></pre>
...
<ul>
    <li><strong><code>Mordhau/Saved/Config/LinuxServer/Game.ini</code></strong> - Main Config File</li>
</ul>
...
<ul>
    <li>Official Mordhau documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Mordhau server hosting</em>
</p>
