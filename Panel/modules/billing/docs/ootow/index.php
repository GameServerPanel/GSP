<?php
/**
 * Outlaws of the Old West Server Documentation - Comprehensive Guide
...
<h1>Outlaws of the Old West Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Outlaws of the Old West is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Outlaws of the Old West server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">915070</code></li>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Outlaws of the Old West server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<p><strong>This game can be installed via SteamCMD using App ID: 915070</strong></p>
...
mkdir -p ~/gameservers/ootow

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/ootow \
         +app_update 915070 validate \
         +quit

# Server files are now in ~/gameservers/ootow/
cd ~/gameservers/ootow
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\ootow ^
             +app_update 915070 validate ^
             +quit
</code></pre>
...
<pre><code>/Game/Maps/MainMap/MainMap -log %IP% %PORT% %QUERY_PORT% %HOSTNAME% %PLAYERS% %CONTROL_PASSWORD% %TYPE%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-Type=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -Type=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">The type of game.</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">PVP</code> - PvP</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">ORR</code> - ORR</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">PVE</code> - PvE</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">RP</code> - RP</li>
        </ul>
    </div>
</div>
...
<ul>
    <li>Official Outlaws of the Old West documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Outlaws of the Old West server hosting</em>
</p>
