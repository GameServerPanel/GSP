...
// Use billing_url helper for portable path-safe redirects.
...
$SITE_ROOT_PATH = rtrim(billing_base_path(), '/');
    ...
    if ($username === '' || $password === '') {
        ...
        if ($res && mysqli_num_rows($res) === 1) {
            ...
            if ($authOk) {
                ...
                if ($destination === '') {
                    $destination = billing_url('index.php');
                }
