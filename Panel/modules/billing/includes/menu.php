...
?>
<link rel="stylesheet" href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('css/header.css') : ($nav_prefix . 'css/header.css')); ?>">
...
<div class="gsw-header">
  <div class="gsw-header-top">
    <div class="gsw-header-left">
      <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('index.php') : ($nav_prefix . 'index.php')); ?>" class="gsw-logo-link">
        <img src="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('images/logo-sm.png') : ($nav_prefix . 'images/logo-sm.png')); ?>" alt="GameServers.World" class="gsw-logo">
    ...
    <div class="gsw-header-right">
      ...
      ?>
      <?php if ($is_logged_in): ?>
        <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('my_account.php') : ($nav_prefix . 'my_account.php')); ?>" class="gsw-user-info">Welcome, <?php echo $username; ?></a>
        <a href="<?php echo billing_nav_escape((function_exists('billing_url') ? billing_url('logout.php') : ($nav_prefix . 'logout.php')) . '?return_to=' . urlencode($return_to_param)); ?>" class="gsw-header-btn">Logout</a>
      <?php else: ?>
        <a href="<?php echo billing_nav_escape((function_exists('billing_url') ? billing_url('login.php') : ($nav_prefix . 'login.php')) . '?return_to=' . urlencode($return_to_param)); ?>" class="gsw-header-btn">Login</a>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="gsw-header-bottom">
    <nav class="gsw-header-nav">
      <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('index.php') : ($nav_prefix . 'index.php')); ?>" class="gsw-nav-link">Home</a>
      <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('serverlist.php') : ($nav_prefix . 'serverlist.php')); ?>" class="gsw-nav-link">Game Servers</a>
      <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('docs.php') : ($nav_prefix . 'docs.php')); ?>" class="gsw-nav-link">Documentation</a>
      <?php if ($is_logged_in): ?>
        <!-- My Account as a regular nav link, not a prominent button -->
        <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('my_account.php') : ($nav_prefix . 'my_account.php')); ?>" class="gsw-nav-link">My Account</a>
        <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('cart.php') : ($nav_prefix . 'cart.php')); ?>" class="gsw-nav-link">Cart
          <?php
            $cart_count = 0;
      ...
      <?php if ($is_logged_in && $is_admin): ?>
        <a href="<?php echo billing_nav_escape(function_exists('billing_url') ? billing_url('admin.php') : ($nav_prefix . 'admin.php')); ?>" class="gsw-nav-link">Admin</a>
      <?php endif; ?>
      <?php $panelRoot = function_exists('billing_runtime_panel_root') ? billing_runtime_panel_root() : null; ?>
      <a href="<?php echo billing_nav_escape($panelRoot ? '/panel/' : (function_exists('billing_url') ? billing_url('index.php') : ($nav_prefix . 'index.php'))); ?>" class="gsw-nav-link">Control Panel</a>
    </nav>
  </div>
</div>
