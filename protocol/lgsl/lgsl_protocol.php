...
//------------------------------------------------------------------------------------------------------------+
	...
	function lgsl_port_conversion($type, $c_port, $q_port, $s_port)
	{
		switch ($type) // GAMES WHERE Q_PORT IS NOT EQUAL TO C_PORT
		{
			...
			case "arma2"			: $c_to_q = 1;		$c_def = 2302;	$q_def = 2303;	$c_to_s = 0;	break;
			case "arma2oa"			: $c_to_q = 1;		$c_def = 2302;	$q_def = 2303;	$c_to_s = 0;	break;
			case "arma2co"			: $c_to_q = 1;		$c_def = 2302;	$q_def = 2303;	$c_to_s = 0;	break;
			...
			case "conanexiles"		: $c_to_q = 1;	$c_def = 7777;	$q_def = 7778;	$c_to_s = 0;	break;
			...
			case "harsh"			: $c_to_q = 3;		$c_def = 7777;	$q_def = 7780;	$c_to_s = 0;	break;
			...
			case "risingstorm2"		: $c_to_q = 19238; 	$c_def = 7777; 	$q_def = 27015; $c_to_s = 0;  	break;
                        case "rust"                 : $c_to_q = 1;        $c_def = 27015;    $q_def = 27016;    $c_to_s = 1;    break;
			...
			case "source"			: $c_to_q = 1;	$c_def = 27000;	$q_def = 27001;	$c_to_s = 0;	break;
