...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        <li><strong style="color: #ffffff;">Default Port:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">9987</code></li>
    ...
    <table style="width: 100%; color: #e5e7eb; border-collapse: collapse;">
        ...
        <tbody>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">9987</code></td>
                <td style="padding: 10px;">UDP</td>
                <td style="padding: 10px;">Voice</td>
            </tr>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">10011</code></td>
                <td style="padding: 10px;">TCP</td>
                <td style="padding: 10px;">ServerQuery</td>
            </tr>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">30033</code></td>
                <td style="padding: 10px;">TCP</td>
                <td style="padding: 10px;">File transfer</td>
            </tr>
        </tbody>
    </table>
