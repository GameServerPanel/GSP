 ...
 */
?>
<h1>TeamSpeak 3 Server Guide</h1>

<h2>Overview</h2>
<p><strong>TeamSpeak 3</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your TeamSpeak 3 server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> teamspeak3_linux32</li>
        <li><strong style="color: #ffffff;">Startup Command:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">voice_ip=%IP% %PORT% query_ip=%IP% %QUERY_PORT% query_ssh_ip=%IP% %QUERY_SSH_PORT% filetransfer_ip=%IP% %FILETRANSFER_PORT% %QP% %CONTROL_PASSWORD% %LICENS% %LOG%</code></li>
        <li><strong style="color: #ffffff;">Log File:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">teamspeak3-server_linux_x86/logs/ts3server_0.log</code></li>
...
<p>To create a TeamSpeak 3 server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>TeamSpeak 3</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your TeamSpeak 3 server:</p>
<ul>
    ...
    <li>Visit the official TeamSpeak 3 community for game-specific help</li>
</ul>
