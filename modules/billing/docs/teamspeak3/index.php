<?php
/**
 * TeamSpeak 3 Server Documentation - Comprehensive Guide
...
<h1>TeamSpeak 3 Server Hosting Guide</h1>

<h2>Overview</h2>
<p>TeamSpeak 3 is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a TeamSpeak 3 server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The TeamSpeak 3 server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<pre><code>voice_ip=%IP% %PORT% query_ip=%IP% %QUERY_PORT% query_ssh_ip=%IP% %QUERY_SSH_PORT% filetransfer_ip=%IP% %FILETRANSFER_PORT% %QP% %CONTROL_PASSWORD% %LICENS% %LOG%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">license_accepted=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - license_accepted=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Agreeing to the TeamSpeak 3 server licence. Can be viewed here.</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">0</code> - Denied</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">1</code> - Accepted</li>
        </ul>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">logappend=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - logappend=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">The log output will be appended to the previous log file.</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">query_protocols=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - query_protocols=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Protocols that can be used to connect to the ServerQuery.</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">raw</code> - Classic</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">raw,ssh</code> - Classic and SSH</li>
        </ul>
    </div>
</div>
...
<ul>
    <li>Official TeamSpeak 3 documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For TeamSpeak 3 server hosting</em>
</p>
