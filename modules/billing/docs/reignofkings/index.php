<?php
/**
 * Reign of Kings Server Documentation - Comprehensive Guide
...
<h1>Reign of Kings Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Reign of Kings is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Reign of Kings server for your community.</p>

<h2 id="quick-info">Quick Info</h2>
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        <li><strong style="color: #ffffff;">Default Port:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">7350</code></li>
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">381690</code></li>
        <li><strong style="color: #ffffff;">Recommended OS:</strong> Linux (Ubuntu/Debian) or Windows Server</li>
            ...
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Configuration/ServerSettings.cfg</code> - Server Configurations</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Configuration/ConsoleSettings.cfg</code> - Console Configurations</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Configuration/Users.cfg</code> - User Configurations</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Configuration/Whitelist.cfg</code> - Whitelist Configurations</li>
        </ul></li>
    </ul>
</div>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Reign of Kings server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<p><strong>This game can be installed via SteamCMD using App ID: 381690</strong></p>
...
mkdir -p ~/gameservers/reignofkings

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/reignofkings \
         +app_update 381690 validate \
         +quit

# Server files are now in ~/gameservers/reignofkings/
cd ~/gameservers/reignofkings
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\reignofkings ^
             +app_update 381690 validate ^
             +quit
</code></pre>
...
<ul>
    <li><strong><code>Configuration/ServerSettings.cfg</code></strong> - Server Configurations</li>
    <li><strong><code>Configuration/ConsoleSettings.cfg</code></strong> - Console Configurations</li>
    <li><strong><code>Configuration/Users.cfg</code></strong> - User Configurations</li>
    <li><strong><code>Configuration/Whitelist.cfg</code></strong> - Whitelist Configurations</li>
</ul>
