<?php
/**
 * OpenTTD Server Documentation - Comprehensive Guide
...
<h1>OpenTTD Server Hosting Guide</h1>

<h2>Overview</h2>
<p>OpenTTD is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a OpenTTD server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Configuration Files:</strong><ul style="margin-top: 8px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">openttd.cfg</code> - Server Configurations</li>
        </ul></li>
    </ul>
</div>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The OpenTTD server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<ul>
    <li><strong><code>openttd.cfg</code></strong> - Server Configurations</li>
</ul>
...
<pre><code>-D %IP%:%PORT% %SAVEGAME%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-g</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -g</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">If no, starts a new game. If yes, loads the latest autosaved game.</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;"></code> - No</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">save/autosave/latest_autosave.sav</code> - Yes</li>
        </ul>
    </div>
</div>
...
<ul>
    <li>Official OpenTTD documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For OpenTTD server hosting</em>
</p>
