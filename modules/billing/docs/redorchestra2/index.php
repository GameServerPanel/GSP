<?php
/**
 * Red Orchestra 2 Server Documentation
 */
?>
<h1>Red Orchestra 2 Server Guide</h1>

<h2>Overview</h2>
<p><strong>Red Orchestra 2</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Red Orchestra 2 server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> redorchestra2_win32</li>
        <li><strong style="color: #ffffff;">Startup Command:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">TE-Apartments?%PORT%?%PLAYERS% -log=ServerLog.log %IP% -brewedloading</code></li>
        <li><strong style="color: #ffffff;">Log File:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">ROGame/Logs/ServerLog.log</code></li>
...
<p>To create a Red Orchestra 2 server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Red Orchestra 2</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Red Orchestra 2 server:</p>
<ul>
    ...
    <li>Visit the official Red Orchestra 2 community for game-specific help</li>
</ul>
