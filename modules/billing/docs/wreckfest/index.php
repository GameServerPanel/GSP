<?php
/**
 * Wreckfest Server Documentation
 */
?>
<h1>Wreckfest Server Guide</h1>

<h2>Overview</h2>
<p><strong>Wreckfest</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Wreckfest server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> wreckfest_win32</li>
        <li><strong style="color: #ffffff;">Startup Command:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">-s server_config=server_config.cfg</code></li>
        ...
        <li><strong style="color: #ffffff;">Default Port:</strong> game_port=.*</li>
        <li><strong style="color: #ffffff;">Max Players:</strong> 24</li>
    </ul>
</div>

<h2>Getting Started</h2>
<p>To create a Wreckfest server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Wreckfest</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Wreckfest server:</p>
<ul>
    ...
    <li>Visit the official Wreckfest community for game-specific help</li>
</ul>
