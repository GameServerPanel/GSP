<?php
/**
 * Wreckfest Server Documentation - Comprehensive Guide
...
<h1>Wreckfest Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Wreckfest is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Wreckfest server for your community.</p>

<h2 id="quick-info">Quick Info</h2>
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        <li><strong style="color: #ffffff;">Default Port:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">33540</code></li>
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">361580</code></li>
        <li><strong style="color: #ffffff;">Recommended OS:</strong> Linux (Ubuntu/Debian) or Windows Server</li>
            ...
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">server_config.cfg</code> - Advanced Modifications</li>
        </ul></li>
    </ul>
</div>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Wreckfest server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<p><strong>This game can be installed via SteamCMD using App ID: 361580</strong></p>
...
mkdir -p ~/gameservers/wreckfest

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/wreckfest \
         +app_update 361580 validate \
         +quit

# Server files are now in ~/gameservers/wreckfest/
cd ~/gameservers/wreckfest
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\wreckfest ^
             +app_update 361580 validate ^
             +quit
</code></pre>
...
<ul>
    <li><strong><code>server_config.cfg</code></strong> - Advanced Modifications</li>
</ul>
