<?php
/**
 * Insurgency Server Documentation - Comprehensive Guide
...
<h1>Insurgency Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Insurgency is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Insurgency server for your community.</p>
...
mkdir -p ~/gameservers/ins

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/ins \
         +app_update 237410 validate \
         +quit

# Server files are now in ~/gameservers/ins/
cd ~/gameservers/ins
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\ins ^
             +app_update 237410 validate ^
             +quit
</code></pre>
