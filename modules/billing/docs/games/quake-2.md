# Quake 2 — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./quake-2_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `quake-2_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/quake-2/server.cfg` — Main server configuration  
- `~/quake-2/config/` — Configuration directory
- `~/quake-2/logs/` — Log files directory
- `~/quake-2/data/` — Server data and saves
...
- Check official mod repositories or community sites for Quake 2
