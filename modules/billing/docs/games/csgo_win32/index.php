<?php
/**
 * Counter Strike Global Offensive Server Documentation
 */
?>
<h1>Counter Strike Global Offensive Server Guide</h1>

<h2>Overview</h2>
<p><strong>Counter Strike Global Offensive</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Counter Strike Global Offensive server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> csgo_win32</li>
...
<p>To create a Counter Strike Global Offensive server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Counter Strike Global Offensive</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Counter Strike Global Offensive server:</p>
<ul>
    ...
    <li>Visit the official Counter Strike Global Offensive community for game-specific help</li>
</ul>
