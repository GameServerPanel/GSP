# The Front — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./the-front_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `the-front_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/the-front/server.cfg` — Main server configuration  
- `~/the-front/config/` — Configuration directory
- `~/the-front/logs/` — Log files directory
- `~/the-front/data/` — Server data and saves
...
- Check official mod repositories or community sites for The Front
