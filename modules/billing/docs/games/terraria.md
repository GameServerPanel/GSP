# Terraria — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./terraria_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `terraria_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/terraria/server.cfg` — Main server configuration  
- `~/terraria/config/` — Configuration directory
- `~/terraria/logs/` — Log files directory
- `~/terraria/data/` — Server data and saves
...
- Check official mod repositories or community sites for Terraria
