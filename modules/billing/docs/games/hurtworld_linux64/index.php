<?php
/**
 * Hurtworld Server Documentation
 */
?>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> hurtworld_linux64</li>
        <li><strong>Installer:</strong> steamcmd</li>
        <li><strong>Max Players:</strong> 60</li>
    </ul>
</div>
...
<h2>Support</h2>
<p>If you need assistance with your Hurtworld server:</p>
<ul>
