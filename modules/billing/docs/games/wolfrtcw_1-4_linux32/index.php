<?php
/**
 * Wolfenstein: Return To Castle Wolfenstein 1.4 Server Documentation
 */
?>
<h1>Wolfenstein: Return To Castle Wolfenstein 1.4 Server Guide</h1>

<h2>Overview</h2>
<p><strong>Wolfenstein: Return To Castle Wolfenstein 1.4</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Wolfenstein: Return To Castle Wolfenstein 1.4 server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> wolfrtcw_1.4_linux32</li>
...
<p>To create a Wolfenstein: Return To Castle Wolfenstein 1.4 server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Wolfenstein: Return To Castle Wolfenstein 1.4</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Wolfenstein: Return To Castle Wolfenstein 1.4 server:</p>
<ul>
    ...
    <li>Visit the official Wolfenstein: Return To Castle Wolfenstein 1.4 community for game-specific help</li>
</ul>
