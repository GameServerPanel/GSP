<?php
/**
 * Smokin Guns Server Documentation
 */
?>
<h1>Smokin Guns Server Guide</h1>

<h2>Overview</h2>
<p><strong>Smokin Guns</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Smokin Guns server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> smokinguns_linux32</li>
        <li><strong>Installer:</strong> smokinguns</li>
        <li><strong>Max Players:</strong> 32</li>
    </ul>
</div>

<h2>Getting Started</h2>
<p>To create a Smokin Guns server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Smokin Guns</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Smokin Guns server:</p>
<ul>
    ...
    <li>Visit the official Smokin Guns community for game-specific help</li>
</ul>
