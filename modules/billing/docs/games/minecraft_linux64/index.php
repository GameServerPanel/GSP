...
<h2>Overview</h2>
<p><strong>Minecraft</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Minecraft server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> minecraft_linux64</li>
...
<p>To create a Minecraft server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Minecraft</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Minecraft server:</p>
<ul>
    ...
    <li>Visit the official Minecraft community for game-specific help</li>
</ul>
