# Wreckfest — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./wreckfest_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `wreckfest_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/wreckfest/server.cfg` — Main server configuration  
- `~/wreckfest/config/` — Configuration directory
- `~/wreckfest/logs/` — Log files directory
- `~/wreckfest/data/` — Server data and saves
...
- Check official mod repositories or community sites for Wreckfest
