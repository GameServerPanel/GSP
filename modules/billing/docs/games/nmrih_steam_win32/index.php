<?php
/**
 * No More Room In Hell Server Documentation
 */
?>
<h1>No More Room In Hell Server Guide</h1>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> nmrih_steam_win32</li>
...
<p>To create a No More Room In Hell server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>No More Room In Hell</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your No More Room In Hell server:</p>
<ul>
