# WaterfallMC — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./waterfallmc_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `waterfallmc_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/waterfallmc/server.cfg` — Main server configuration  
- `~/waterfallmc/config/` — Configuration directory
- `~/waterfallmc/logs/` — Log files directory
- `~/waterfallmc/data/` — Server data and saves
...
- Check official mod repositories or community sites for WaterfallMC
