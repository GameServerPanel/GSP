<?php
/**
 * Nexuiz Server Documentation
 */
?>
<h1>Nexuiz Server Guide</h1>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> nexuiz_linux64</li>
...
<p>To create a Nexuiz server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Nexuiz</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Nexuiz server:</p>
<ul>
