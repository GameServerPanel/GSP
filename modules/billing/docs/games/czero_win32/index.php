<?php
/**
 * Counter-Strike Condition Zero Server Documentation
 */
?>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> czero_win32</li>
...
<h2>Support</h2>
<p>If you need assistance with your Counter-Strike Condition Zero server:</p>
<ul>
