<?php
/**
 * Just Cause 2 Multiplayer (Windows) Server Documentation
 */
?>
<h1>Just Cause 2 Multiplayer (Windows) Server Guide</h1>

<h2>Overview</h2>
<p><strong>Just Cause 2 Multiplayer (Windows)</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Just Cause 2 Multiplayer (Windows) server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> jcmp_win32</li>
...
<p>To create a Just Cause 2 Multiplayer (Windows) server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Just Cause 2 Multiplayer (Windows)</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Just Cause 2 Multiplayer (Windows) server:</p>
<ul>
    ...
    <li>Visit the official Just Cause 2 Multiplayer (Windows) community for game-specific help</li>
</ul>
