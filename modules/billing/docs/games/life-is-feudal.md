# Life is Feudal — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./life-is-feudal_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `life-is-feudal_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/life-is-feudal/server.cfg` — Main server configuration  
- `~/life-is-feudal/config/` — Configuration directory
- `~/life-is-feudal/logs/` — Log files directory
- `~/life-is-feudal/data/` — Server data and saves
...
- Check official mod repositories or community sites for Life is Feudal
