<?php
/**
 * Quake 3 Server Documentation
 */
?>
<h1>Quake 3 Server Guide</h1>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> quake3_linux32</li>
...
<p>To create a Quake 3 server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Quake 3</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Quake 3 server:</p>
<ul>
    ...
    <li>Visit the official Quake 3 community for game-specific help</li>
</ul>
