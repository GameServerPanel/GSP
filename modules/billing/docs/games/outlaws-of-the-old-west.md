# Outlaws of the Old West — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./outlaws-of-the-old-west_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `outlaws-of-the-old-west_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/outlaws-of-the-old-west/server.cfg` — Main server configuration  
- `~/outlaws-of-the-old-west/config/` — Configuration directory
- `~/outlaws-of-the-old-west/logs/` — Log files directory
- `~/outlaws-of-the-old-west/data/` — Server data and saves
...
- Check official mod repositories or community sites for Outlaws of the Old West
