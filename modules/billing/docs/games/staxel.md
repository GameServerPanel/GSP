# Staxel — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./staxel_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `staxel_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/staxel/server.cfg` — Main server configuration  
- `~/staxel/config/` — Configuration directory
- `~/staxel/logs/` — Log files directory
- `~/staxel/data/` — Server data and saves
...
- Check official mod repositories or community sites for Staxel
