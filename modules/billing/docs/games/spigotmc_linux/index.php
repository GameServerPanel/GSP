<?php
/**
 * Spigot Server Server Documentation
 */
?>
<h1>Spigot Server Server Guide</h1>

<h2>Overview</h2>
<p><strong>Spigot Server</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Spigot Server server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> spigotmc_linux</li>
...
<p>To create a Spigot Server server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Spigot Server</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Spigot Server server:</p>
<ul>
    ...
    <li>Visit the official Spigot Server community for game-specific help</li>
</ul>
