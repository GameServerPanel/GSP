...
**Windows:**
- `teeworlds_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/teeworlds/server.cfg` — Main server configuration  
- `~/teeworlds/config/` — Configuration directory
- `~/teeworlds/logs/` — Log files directory
- `~/teeworlds/data/` — Server data and saves
