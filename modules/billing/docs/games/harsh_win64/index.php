<?php
/**
 * Operation Harsh Doorstop Server Documentation
 */
?>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> harsh_win64</li>
...
<h2>Support</h2>
<p>If you need assistance with your Operation Harsh Doorstop server:</p>
<ul>
