<?php
/**
 * Nuclear Dawn Server Documentation
 */
?>
<h1>Nuclear Dawn Server Guide</h1>

<h2>Overview</h2>
<p><strong>Nuclear Dawn</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Nuclear Dawn server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> nucleardawn_win32</li>
...
<p>To create a Nuclear Dawn server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Nuclear Dawn</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Nuclear Dawn server:</p>
<ul>
    ...
    <li>Visit the official Nuclear Dawn community for game-specific help</li>
</ul>
