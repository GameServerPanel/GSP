# Survive the Nights — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./survive-the-nights_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `survive-the-nights_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/survive-the-nights/server.cfg` — Main server configuration  
- `~/survive-the-nights/config/` — Configuration directory
- `~/survive-the-nights/logs/` — Log files directory
- `~/survive-the-nights/data/` — Server data and saves
...
- Check official mod repositories or community sites for Survive the Nights
