<?php
/**
 * Rigs of Rods Server Documentation
 */
?>
<h1>Rigs of Rods Server Guide</h1>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> rorserver_linux32</li>
...
<p>To create a Rigs of Rods server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Rigs of Rods</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Rigs of Rods server:</p>
<ul>
    ...
    <li>Visit the official Rigs of Rods community for game-specific help</li>
</ul>
