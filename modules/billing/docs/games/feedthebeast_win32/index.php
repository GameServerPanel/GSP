<?php
/**
 * Feed The Beast Server Server Documentation
 */
?>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> feedthebeast_win32</li>
...
<h2>Support</h2>
<p>If you need assistance with your Feed The Beast Server server:</p>
<ul>
