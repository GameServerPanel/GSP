# Warsow — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./warsow_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `warsow_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/warsow/server.cfg` — Main server configuration  
- `~/warsow/config/` — Configuration directory
- `~/warsow/logs/` — Log files directory
- `~/warsow/data/` — Server data and saves
...
- Check official mod repositories or community sites for Warsow
