# Myth of Empires — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./myth-of-empires_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `myth-of-empires_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/myth-of-empires/server.cfg` — Main server configuration  
- `~/myth-of-empires/config/` — Configuration directory
- `~/myth-of-empires/logs/` — Log files directory
- `~/myth-of-empires/data/` — Server data and saves
...
- Check official mod repositories or community sites for Myth of Empires
