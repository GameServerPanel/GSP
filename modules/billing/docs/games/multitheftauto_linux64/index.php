<?php
/**
 * Multi Theft Auto Server Documentation
 */
?>
<h1>Multi Theft Auto Server Guide</h1>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> multitheftauto_linux64</li>
...
<p>To create a Multi Theft Auto server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Multi Theft Auto</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Multi Theft Auto server:</p>
<ul>
