<?php
/**
 * TrackMania Nations Server Documentation
 */
?>
<h1>TrackMania Nations Server Guide</h1>
...
<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> trackmanianations_linux32</li>
...
<p>To create a TrackMania Nations server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>TrackMania Nations</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your TrackMania Nations server:</p>
<ul>
    ...
    <li>Visit the official TrackMania Nations community for game-specific help</li>
</ul>
