<?php
/**
 * TeamSpeak 2 Server Documentation - Comprehensive Guide
...
<h1>TeamSpeak 2 Server Hosting Guide</h1>

<h2>Overview</h2>
<p>TeamSpeak 2 is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a TeamSpeak 2 server for your community.</p>

<h2 id="quick-info">Quick Info</h2>
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        <li><strong style="color: #ffffff;">Default Port:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">8767</code></li>
    ...
    <table style="width: 100%; color: #e5e7eb; border-collapse: collapse;">
        ...
        <tbody>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">8767</code></td>
                <td style="padding: 10px;">UDP</td>
                <td style="padding: 10px;">Voice</td>
            </tr>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">14534</code></td>
                <td style="padding: 10px;">TCP</td>
                <td style="padding: 10px;">Weblist</td>
            </tr>
        </tbody>
    </table>
...
<ul>
    <li>Official TeamSpeak 2 documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For TeamSpeak 2 server hosting</em>
</p>
