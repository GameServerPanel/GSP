<?php
/**
 * Vice City Multiplayer Server Documentation
 */
?>
<h1>Vice City Multiplayer Server Guide</h1>

<h2>Overview</h2>
<p><strong>Vice City Multiplayer</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Vice City Multiplayer server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> vicecitymp_linux32</li>
...
<p>To create a Vice City Multiplayer server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Vice City Multiplayer</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Vice City Multiplayer server:</p>
<ul>
    ...
    <li>Visit the official Vice City Multiplayer community for game-specific help</li>
</ul>
