<?php
/**
 * Pirates, Vikings and Knights II Server Documentation
 */
?>
<h1>Pirates, Vikings and Knights II Server Guide</h1>
...
<p>To create a Pirates, Vikings and Knights II server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Pirates, Vikings and Knights II</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Pirates, Vikings and Knights II server:</p>
<ul>
