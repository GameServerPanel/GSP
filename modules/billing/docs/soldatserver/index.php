<?php
/**
 * Soldat Server Documentation
 */
?>
<h1>Soldat Server Guide</h1>

<h2>Overview</h2>
<p><strong>Soldat</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Soldat server.</p>

<div style="background: #f0f7ff; padding: 15px; border-left: 4px solid #0066cc; margin: 20px 0;">
    <h3>Quick Info</h3>
    <ul>
        <li><strong>Game Key:</strong> soldatserver_linux32</li>
...
<p>To create a Soldat server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Soldat</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Soldat server:</p>
<ul>
    ...
    <li>Visit the official Soldat community for game-specific help</li>
</ul>
