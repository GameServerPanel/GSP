<?php
/**
 * Shoutcast server Server Documentation
 */
?>
<h1>Shoutcast server Server Guide</h1>

<h2>Overview</h2>
<p><strong>Shoutcast server</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Shoutcast server server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> shoutcast</li>
        <li><strong style="color: #ffffff;">Startup Command:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">sc_serv_ogp.conf</code></li>
        ...
        <li><strong style="color: #ffffff;">Default Port:</strong> portbase=.*</li>
        <li><strong style="color: #ffffff;">Max Players:</strong> 1000</li>
    </ul>
</div>

<h2>Getting Started</h2>
<p>To create a Shoutcast server server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Shoutcast server</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Shoutcast server server:</p>
<ul>
    ...
    <li>Visit the official Shoutcast server community for game-specific help</li>
</ul>
