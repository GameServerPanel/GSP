...
<pre><code>%MAP%%GAMEMODE%%DIFFICULTY%%GAMELENGTH%%PLAYERS% %PORT% %IP% %WEB_ADMIN_PORT% %QUERY_PORT%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        ...
        <p style="color: #e5e7eb; margin: 10px 0;">This sets the server difficulty. Leave empty to configure this parameter in the config files or webadmin</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;"></code> - </li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">0</code> - Normal</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">1</code> - Hard</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">2</code> - Suicidal</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">3</code> - Hell on Earth</li>
        </ul>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">?GameLength=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Game Length</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">This sets the game length. Leave empty to configure this parameter in the config files or webadmin</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;"></code> - </li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">0</code> - Short</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">1</code> - Medium</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">2</code> - Long</li>
        </ul>
    </div>
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        ...
        <p style="color: #e5e7eb; margin: 10px 0;">Leave empty to run the normal game mode.To run your server with official Versus Survival mode use this:KFGameContent.KFGameInfo_VersusSurvivalYou can use any other gametype if you installed any other mod from Steam Workshop</p>
    </div>
</div>
