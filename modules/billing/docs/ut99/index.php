<?php
/**
 * Unreal Tournament Server Documentation
 */
?>
<h1>Unreal Tournament Server Guide</h1>

<h2>Overview</h2>
<p><strong>Unreal Tournament</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Unreal Tournament server.</p>
...
<p>To create a Unreal Tournament server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Unreal Tournament</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Unreal Tournament server:</p>
<ul>
    ...
    <li>Visit the official Unreal Tournament community for game-specific help</li>
</ul>
