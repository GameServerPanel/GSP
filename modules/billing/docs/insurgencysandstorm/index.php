...
<pre><code>%MAP%%SCENARIO%%PLAYERS%%PASSWORD% %PORT% %QUERY_PORT% %SERVERNAME% %MAPCYCLE% %CONTROL_PASSWORD% %RCON_PORT%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-GSLTToken=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Game Server Login Token</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Manage your tokens here</p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-GameStats</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Game Stats</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Enable Game Stats</p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-mutators=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Mutators</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Mutators to be used on the server, separate multiple mutators with a comma and no space</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">OfficialRules</code></p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-hostname=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Server name</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">The desired server name</p>
    </div>
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        ...
        <p style="color: #e5e7eb; margin: 10px 0;">The password used to join the server</p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">?Scenario=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Scenario</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">This is the scenario to be used with the map. Needs to be a valid scenario for the selected map</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Crossing_Checkpoint_Insurgents</code> - Canyon Checkpoint Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Crossing_Checkpoint_Security</code> - Canyon Checkpoint Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Farmhouse_Checkpoint_Insurgents</code> - Farmhouse Checkpoint Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Farmhouse_Checkpoint_Security</code> - Farmhouse Checkpoint Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Summit_Checkpoint_Insurgents</code> - Mountain Checkpoint Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Summit_Checkpoint_Security</code> - Mountain Checkpoint Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Refinery_Checkpoint_Insurgents</code> - Oilfield Checkpoint Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Refinery_Checkpoint_Security</code> - Oilfield Checkpoint Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Precinct_Checkpoint_Insurgents</code> - Precinct Checkpoint Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Precinct_Checkpoint_Security</code> - Precinct Checkpoint Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Hideout_Checkpoint_Insurgents</code> - Town Checkpoint Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Hideout_Checkpoint_Security</code> - Town Checkpoint Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Crossing_Firefight_West</code> - Canyon Firefight West</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Farmhouse_Firefight_East</code> - Farmhouse Firefight East</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Farmhouse_Firefight_West</code> - Farmhouse Firefight West</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Summit_Firefight_East</code> - Mountain Firefight East</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Summit_Firefight_West</code> - Mountain Firefight West</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Refinery_Firefight_West</code> - Oilfield Firefight West</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Precinct_Firefight_East</code> - Precinct Firefight East</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Precinct_Firefight_West</code> - Precinct Firefight West</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Hideout_Firefight_East</code> - Town Firefight East</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Hideout_Firefight_West</code> - Town Firefight West</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Crossing_Push_Insurgents</code> - Canyon Push Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Crossing_Push_Security</code> - Canyon Push Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Farmhouse_Push_Insurgents</code> - Farmhouse Push Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Farmhouse_Push_Security</code> - Farmhouse Push Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Summit_Push_Insurgents</code> - Mountain Push Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Summit_Push_Security</code> - Mountain Push Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Refinery_Push_Insurgents</code> - Oilfield Push Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Refinery_Push_Security</code> - Oilfield Push Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Precinct_Push_Insurgents</code> - Precinct Push Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Precinct_Push_Security</code> - Precinct Push Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Hideout_Push_Insurgents</code> - Town Push Insurgents</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Hideout_Push_Security</code> - Town Push Security</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Crossing_Skirmish</code> - Canyon Skirmish</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Farmhouse_Skirmish</code> - Farmhouse Skirmish</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Summit_Skirmish</code> - Mountain Skirmish</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Refinery_Skirmish</code> - Oilfield Skirmish</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Precinct_Skirmish</code> - Precinct Skirmish</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Scenario_Hideout_Skirmish</code> - Town Skirmish</li>
        </ul>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-MapCycle=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Map cycle</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">This is the map cycle, Default will cycle through all PVP scenarios available, Custom will use the file Insurgency/Config/Server/MapCycleCustom.txt</p>
        <p style="color: #e5e7eb;"><strong>Options:</strong></p>
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;"></code> - Default</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">MapCycleCustom</code> - Custom</li>
        </ul>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-Rcon</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - RCON</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Enable RCON protocol (on server port + 10). Use tools like McRCON to administer your server. RCON commands can be found here</p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-EnableCheats</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - Cheats</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Enable the cheats to be used from the ingame Admin menu</p>
    </div>
</div>
