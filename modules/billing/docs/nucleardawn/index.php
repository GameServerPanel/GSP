<?php
/**
 * Nuclear Dawn (Linux) Server Documentation
 */
?>
<h1>Nuclear Dawn (Linux) Server Guide</h1>
...
<p>To create a Nuclear Dawn (Linux) server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Nuclear Dawn (Linux)</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Nuclear Dawn (Linux) server:</p>
<ul>
