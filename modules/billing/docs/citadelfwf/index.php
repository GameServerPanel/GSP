<?php
/**
 * Citadel: Forged with Fire Server Documentation - Comprehensive Guide
...
<h1>Citadel: Forged with Fire Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Citadel: Forged with Fire is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Citadel: Forged with Fire server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Recommended OS:</strong> Linux (Ubuntu/Debian) or Windows Server</li>
            ...
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Citadel/Saved/Config/LinuxServer/Game.ini</code> - Server Configurations</li>
        </ul></li>
    </ul>
</div>
...
<ul>
    <li><strong><code>Citadel/Saved/Config/LinuxServer/Game.ini</code></strong> - Server Configurations</li>
</ul>
