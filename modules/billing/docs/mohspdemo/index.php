<?php
/**
 * Medal Of Honor: Spearhead Demo Server (Windows) Server Documentation
 */
?>
...
<h2>Support</h2>
<p>If you need assistance with your Medal Of Honor: Spearhead Demo Server (Windows) server:</p>
<ul>
