<?php
/**
 * Outlaws of the Old West Server Documentation
 */
?>
<h1>Outlaws of the Old West Server Guide</h1>
...
<p>To create a Outlaws of the Old West server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Outlaws of the Old West</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Outlaws of the Old West server:</p>
<ul>
