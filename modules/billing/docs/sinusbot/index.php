<?php
/**
 * SinusBot for TS 3 and Discord Server Documentation
 */
?>
<h1>SinusBot for TS 3 and Discord Server Guide</h1>

<h2>Overview</h2>
<p><strong>SinusBot for TS 3 and Discord</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your SinusBot for TS 3 and Discord server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> sinusbot_linux64</li>
        <li><strong style="color: #ffffff;">Startup Command:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">%CONTROL_PASSWORD%</code></li>
        ...
        <li><strong style="color: #ffffff;">Default Port:</strong> ListenPort.*</li>
        <li><strong style="color: #ffffff;">Max Players:</strong> 1</li>
    </ul>
</div>

<h2>Getting Started</h2>
<p>To create a SinusBot for TS 3 and Discord server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>SinusBot for TS 3 and Discord</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your SinusBot for TS 3 and Discord server:</p>
<ul>
    ...
    <li>Visit the official SinusBot for TS 3 and Discord community for game-specific help</li>
</ul>
