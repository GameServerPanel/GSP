<?php
/**
 * Rising Storm 2: Vietnam Server Documentation
 */
?>
<h1>Rising Storm 2: Vietnam Server Guide</h1>

<h2>Overview</h2>
<p><strong>Rising Storm 2: Vietnam</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Rising Storm 2: Vietnam server.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <ul style="color: #e5e7eb; line-height: 1.8;">
        ...
        <li><strong style="color: #ffffff;">Additional Info:</strong> Query port is 27016 UDP</li>
    </ul>
...
<p>To create a Rising Storm 2: Vietnam server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Rising Storm 2: Vietnam</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Rising Storm 2: Vietnam server:</p>
<ul>
    ...
    <li>Visit the official Rising Storm 2: Vietnam community for game-specific help</li>
</ul>
