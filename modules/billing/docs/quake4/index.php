<?php
/**
 * Quake 4 Server Documentation
 */
?>
<h1>Quake 4 Server Guide</h1>

<h2>Overview</h2>
<p><strong>Quake 4</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Quake 4 server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Server Information</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Default Port:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">27666</code></li>
...
<p>To create a Quake 4 server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Quake 4</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Quake 4 server:</p>
<ul>
    ...
    <li>Visit the official Quake 4 community for game-specific help</li>
</ul>
