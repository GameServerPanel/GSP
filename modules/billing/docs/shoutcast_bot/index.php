<?php
/**
 * Shoutcast server Bot Server Documentation
 */
?>
<h1>Shoutcast server Bot Server Guide</h1>

<h2>Overview</h2>
<p><strong>Shoutcast server Bot</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Shoutcast server Bot server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> shoutcast_bot</li>
...
<p>To create a Shoutcast server Bot server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Shoutcast server Bot</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Shoutcast server Bot server:</p>
<ul>
    ...
    <li>Visit the official Shoutcast server Bot community for game-specific help</li>
</ul>
