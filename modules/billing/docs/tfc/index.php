<?php
/**
 * Team Fortress Classic Server Documentation
 */
?>
<h1>Team Fortress Classic Server Guide</h1>

<h2>Overview</h2>
<p><strong>Team Fortress Classic</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Team Fortress Classic server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> tfc</li>
...
<p>To create a Team Fortress Classic server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Team Fortress Classic</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Team Fortress Classic server:</p>
<ul>
    ...
    <li>Visit the official Team Fortress Classic community for game-specific help</li>
</ul>
