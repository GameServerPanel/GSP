<?php
/**
 * Stationeers Server Documentation - Comprehensive Guide
...
<h1>Stationeers Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Stationeers is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Stationeers server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Steam App ID:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">600760</code></li>
        ...
        <li><strong style="color: #ffffff;">Configuration Files:</strong><ul style="margin-top: 8px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">default.ini</code> - Server Configurations</li>
        </ul></li>
    </ul>
</div>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Stationeers server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
# Windows Firewall
netsh advfirewall firewall add rule name="Stationeers Server" dir=in action=allow protocol=TCP localport=[PORT]
netsh advfirewall firewall add rule name="Stationeers Server" dir=in action=allow protocol=UDP localport=[PORT]
</code></pre>
...
<p><strong>This game can be installed via SteamCMD using App ID: 600760</strong></p>
...
mkdir -p ~/gameservers/stationeers

# Run SteamCMD and download
steamcmd +login anonymous \
         +force_install_dir ~/gameservers/stationeers \
         +app_update 600760 validate \
         +quit

# Server files are now in ~/gameservers/stationeers/
cd ~/gameservers/stationeers
ls -la
</code></pre>
...
steamcmd.exe +login anonymous ^
             +force_install_dir C:\gameservers\stationeers ^
             +app_update 600760 validate ^
             +quit
</code></pre>
...
<ul>
    <li><strong><code>default.ini</code></strong> - Server Configurations</li>
</ul>
...
<pre><code>-autostart -batchmode -nographics %HOSTNAME% %PORT% %QUERY_PORT% %WORLDNAME% %LOADNAME% %SAVEINTERVAL% %PLAYERRETAIN% %MAP% -logfile output.txt </code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-worldname=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -worldname=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Save Name file</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">my_game</code></p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-loadworld=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -loadworld=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Save Name file</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">my_game</code></p>
    </div>
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-clearallinterval=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -clearallinterval=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Amount of time to keep player active after logoff/disconnect (seconds)</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">900</code></p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-autosaveinterval=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -autosaveinterval=</span>
        </h4>
        <p style="color: #e5e7eb; margin: 10px 0;">Interval in Seconds for save</p>
        <p style="color: #fbbf24;"><strong>Default:</strong> <code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">300</code></p>
    </div>

    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        <h4 style="color: #ffffff; margin-top: 0;">
            <code style="background: #0f172a; padding: 4px 8px; border-radius: 3px; color: #a5b4fc;">-worldtype=</code>
            <span style="color: #e5e7eb; font-weight: normal; font-size: 0.9em;"> - -worldtype=</span>
        </h4>
        ...
        <ul style="color: #e5e7eb; margin-left: 20px;">
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Moon</code> - Moon</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Space</code> - Space</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">Mars</code> - Mars</li>
        </ul>
    </div>
</div>
...
<ul>
    <li>Official Stationeers documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Stationeers server hosting</em>
</p>
