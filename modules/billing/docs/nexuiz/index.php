<?php
/**
 * Nexuiz Server Documentation - Comprehensive Guide
...
<h1>Nexuiz Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Nexuiz is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Nexuiz server for your community.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <p style="color: #e5e7eb;">The Nexuiz server typically uses a configurable port. Check your server configuration files for the specific port settings.</p>
...
<pre><code>server +set dedicated 2 %IP% %PORT% %PLAYERS%</code></pre>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #374151;">
        ...
        <ul style="color: #e5e7eb; margin-left: 20px;">
            ...
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">runematch 1</code> - Rune Match</li>
...
<ul>
    <li>Official Nexuiz documentation and forums</li>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Nexuiz server hosting</em>
</p>
