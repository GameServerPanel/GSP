<?php
/**
 * Sniper Elite V2 Server Documentation
 */
?>
<h1>Sniper Elite V2 Server Guide</h1>

<h2>Overview</h2>
<p><strong>Sniper Elite V2</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Sniper Elite V2 server.</p>

<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <h3 style="color: #ffffff; margin-top: 0;">Quick Info</h3>
    <ul style="color: #e5e7eb; line-height: 1.8;">
        <li><strong style="color: #ffffff;">Game Key:</strong> sniperelitev2_win32</li>
        ...
        <li><strong style="color: #ffffff;">Default Port:</strong> Server.LobbyPort.*</li>
        <li><strong style="color: #ffffff;">Max Players:</strong> 12</li>
    </ul>
</div>

<h2>Getting Started</h2>
<p>To create a Sniper Elite V2 server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Sniper Elite V2</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Sniper Elite V2 server:</p>
<ul>
    ...
    <li>Visit the official Sniper Elite V2 community for game-specific help</li>
</ul>
