<?php
/**
 * Arma Reforger Server Documentation - Comprehensive Guide
...
<h1>Arma Reforger Server Hosting Guide</h1>

<h2>Overview</h2>
<p>Arma Reforger is a multiplayer game server that can be hosted on a VPS or dedicated server. This comprehensive guide covers everything you need to know about hosting a Arma Reforger server for your community.</p>
    ...
    <table style="width: 100%; color: #e5e7eb; border-collapse: collapse;">
        ...
        <tbody>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">2001</code></td>
                <td style="padding: 10px;">UDP</td>
                <td style="padding: 10px;">Game port</td>
            </tr>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">2002</code></td>
                <td style="padding: 10px;">UDP</td>
...
<p style="text-align: center; margin-top: 30px; color: #666;">
    <em>Last updated: November 2025 | For Arma Reforger server hosting</em>
</p>
