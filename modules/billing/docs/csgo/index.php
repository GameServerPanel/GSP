...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    <ul style="color: #e5e7eb; line-height: 1.8; margin: 0;">
        ...
        <li><strong style="color: #ffffff;">Recommended OS:</strong> Linux (Ubuntu/Debian) or Windows Server</li>
            ...
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">csgo/cfg/autoexec.cfg</code> - Server settings</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">csgo/gamemodes_server.txt</code> - Server settings</li>
            <li><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px; color: #a5b4fc;">csgo/mapcycle.txt</code> - Mapcycle</li>
...
<ul>
    ...
    <li><strong><code>csgo/cfg/autoexec.cfg</code></strong> - Server settings</li>
    <li><strong><code>csgo/gamemodes_server.txt</code></strong> - Server settings</li>
    <li><strong><code>csgo/mapcycle.txt</code></strong> - Mapcycle</li>
