<?php
/**
 * Urban Terror 4 Server Documentation
 */
?>
<h1>Urban Terror 4 Server Guide</h1>

<h2>Overview</h2>
<p><strong>Urban Terror 4</strong> is available for hosting on our platform. This guide covers the basics of setting up and managing your Urban Terror 4 server.</p>
...
<div style="background: #1e3a5f; padding: 20px; border-left: 4px solid #3b82f6; margin: 20px 0; border-radius: 4px;">
    ...
    <ul style="color: #e5e7eb; line-height: 1.8;">
        ...
        <li><strong style="color: #ffffff;">Additional Info:</strong> Urban Terror default port</li>
    </ul>
...
<p>To create a Urban Terror 4 server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Urban Terror 4</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Urban Terror 4 server:</p>
<ul>
    ...
    <li>Visit the official Urban Terror 4 community for game-specific help</li>
</ul>
