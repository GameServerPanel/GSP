<?php
/**
 * Mordhau Server Documentation
 */
?>
<h1>Mordhau Server Guide</h1>
...
<p>To create a Mordhau server:</p>
<ol>
    <li>Navigate to the <a href="/serverlist.php">Game Servers</a> page</li>
    <li>Find <strong>Mordhau</strong> in the list</li>
...
<h2>Support</h2>
<p>If you need assistance with your Mordhau server:</p>
<ul>
