...
<p style="color: #e5e7eb;">The following ports are used by this game server:</p>
    <table style="width: 100%; color: #e5e7eb; border-collapse: collapse;">
        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">26901</code></td>
                <td style="padding: 10px;">UDP</td>
                <td style="padding: 10px;">Query port (+1)</td>
            </tr>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">26902</code></td>
                <td style="padding: 10px;">UDP</td>
                <td style="padding: 10px;">Web control panel (+2)</td>
            </tr>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">8080</code></td>
                <td style="padding: 10px;">TCP</td>
                <td style="padding: 10px;">Web dashboard</td>
            </tr>
            <tr style="border-bottom: 1px solid #374151;">
                <td style="padding: 10px;"><code style="background: #0f172a; padding: 2px 6px; border-radius: 3px;">8081</code></td>
                <td style="padding: 10px;">TCP</td>
                <td style="padding: 10px;">Telnet</td>
            </tr>
        </tbody>
    </table>
