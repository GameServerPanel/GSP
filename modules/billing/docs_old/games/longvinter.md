# Longvinter — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./longvinter_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `longvinter_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/longvinter/server.cfg` — Main server configuration  
- `~/longvinter/config/` — Configuration directory
- `~/longvinter/logs/` — Log files directory
- `~/longvinter/data/` — Server data and saves
...
- Check official mod repositories or community sites for Longvinter
