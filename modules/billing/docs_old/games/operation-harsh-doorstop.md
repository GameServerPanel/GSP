# Operation: Harsh Doorstop — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./operation-harsh-doorstop_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `operation-harsh-doorstop_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/operation-harsh-doorstop/server.cfg` — Main server configuration  
- `~/operation-harsh-doorstop/config/` — Configuration directory
- `~/operation-harsh-doorstop/logs/` — Log files directory
- `~/operation-harsh-doorstop/data/` — Server data and saves
...
- Check official mod repositories or community sites for Operation: Harsh Doorstop
