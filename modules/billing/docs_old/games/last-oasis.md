# Last Oasis — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./last-oasis_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `last-oasis_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/last-oasis/server.cfg` — Main server configuration  
- `~/last-oasis/config/` — Configuration directory
- `~/last-oasis/logs/` — Log files directory
- `~/last-oasis/data/` — Server data and saves
...
- Check official mod repositories or community sites for Last Oasis
