# Vampire Slayer — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./vampire-slayer_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `vampire-slayer_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/vampire-slayer/server.cfg` — Main server configuration  
- `~/vampire-slayer/config/` — Configuration directory
- `~/vampire-slayer/logs/` — Log files directory
- `~/vampire-slayer/data/` — Server data and saves
...
- Check official mod repositories or community sites for Vampire Slayer
