# Vintage Story — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./vintage-story_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `vintage-story_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/vintage-story/server.cfg` — Main server configuration  
- `~/vintage-story/config/` — Configuration directory
- `~/vintage-story/logs/` — Log files directory
- `~/vintage-story/data/` — Server data and saves
...
- Check official mod repositories or community sites for Vintage Story
