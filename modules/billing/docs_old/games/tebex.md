# Tebex — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./tebex_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `tebex_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/tebex/server.cfg` — Main server configuration  
- `~/tebex/config/` — Configuration directory
- `~/tebex/logs/` — Log files directory
- `~/tebex/data/` — Server data and saves
...
- Check official mod repositories or community sites for Tebex
