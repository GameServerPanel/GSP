# Ricochet — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./ricochet_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `ricochet_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/ricochet/server.cfg` — Main server configuration  
- `~/ricochet/config/` — Configuration directory
- `~/ricochet/logs/` — Log files directory
- `~/ricochet/data/` — Server data and saves
...
- Check official mod repositories or community sites for Ricochet
