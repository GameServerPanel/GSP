# Teamspeak 3 — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./teamspeak-3_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `teamspeak-3_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/teamspeak-3/server.cfg` — Main server configuration  
- `~/teamspeak-3/config/` — Configuration directory
- `~/teamspeak-3/logs/` — Log files directory
- `~/teamspeak-3/data/` — Server data and saves
...
- Check official mod repositories or community sites for Teamspeak 3
