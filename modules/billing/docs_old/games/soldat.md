# Soldat — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./soldat_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `soldat_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/soldat/server.cfg` — Main server configuration  
- `~/soldat/config/` — Configuration directory
- `~/soldat/logs/` — Log files directory
- `~/soldat/data/` — Server data and saves
...
- Check official mod repositories or community sites for Soldat
