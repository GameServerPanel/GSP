# The Forest — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./the-forest_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `the-forest_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/the-forest/server.cfg` — Main server configuration  
- `~/the-forest/config/` — Configuration directory
- `~/the-forest/logs/` — Log files directory
- `~/the-forest/data/` — Server data and saves
...
- Check official mod repositories or community sites for The Forest
