# Unreal Tournament 3 — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./unreal-tournament-3_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `unreal-tournament-3_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/unreal-tournament-3/server.cfg` — Main server configuration  
- `~/unreal-tournament-3/config/` — Configuration directory
- `~/unreal-tournament-3/logs/` — Log files directory
- `~/unreal-tournament-3/data/` — Server data and saves
...
- Check official mod repositories or community sites for Unreal Tournament 3
