# Velocity Proxy — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./velocity-proxy_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `velocity-proxy_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/velocity-proxy/server.cfg` — Main server configuration  
- `~/velocity-proxy/config/` — Configuration directory
- `~/velocity-proxy/logs/` — Log files directory
- `~/velocity-proxy/data/` — Server data and saves
...
- Check official mod repositories or community sites for Velocity Proxy
