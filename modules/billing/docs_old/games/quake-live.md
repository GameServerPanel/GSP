# Quake Live — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./quake-live_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `quake-live_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/quake-live/server.cfg` — Main server configuration  
- `~/quake-live/config/` — Configuration directory
- `~/quake-live/logs/` — Log files directory
- `~/quake-live/data/` — Server data and saves
...
- Check official mod repositories or community sites for Quake Live
