# Quake 3: Arena — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./quake-3-arena_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `quake-3-arena_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/quake-3-arena/server.cfg` — Main server configuration  
- `~/quake-3-arena/config/` — Configuration directory
- `~/quake-3-arena/logs/` — Log files directory
- `~/quake-3-arena/data/` — Server data and saves
...
- Check official mod repositories or community sites for Quake 3: Arena
