# Killing Floor 2 — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./killing-floor-2_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `killing-floor-2_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/killing-floor-2/server.cfg` — Main server configuration  
- `~/killing-floor-2/config/` — Configuration directory
- `~/killing-floor-2/logs/` — Log files directory
- `~/killing-floor-2/data/` — Server data and saves
...
- Check official mod repositories or community sites for Killing Floor 2
