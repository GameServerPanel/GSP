# Onset — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./onset_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `onset_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/onset/server.cfg` — Main server configuration  
- `~/onset/config/` — Configuration directory
- `~/onset/logs/` — Log files directory
- `~/onset/data/` — Server data and saves
...
- Check official mod repositories or community sites for Onset
