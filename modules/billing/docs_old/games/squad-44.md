# Squad 44 — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./squad-44_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `squad-44_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/squad-44/server.cfg` — Main server configuration  
- `~/squad-44/config/` — Configuration directory
- `~/squad-44/logs/` — Log files directory
- `~/squad-44/data/` — Server data and saves
...
- Check official mod repositories or community sites for Squad 44
