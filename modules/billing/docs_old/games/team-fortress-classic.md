# Team Fortress Classic — Complete Dedicated Server Guide

## Startup Parameters
**Default command line**
```bash
./team-fortress-classic_server -port 27015 -maxplayers 16 -config server.cfg
```
...
**Windows:**
- `team-fortress-classic_server.cfg` — Main server configuration
- `config/` — Configuration directory
- `logs/` — Log files directory
- `data/` — Server data and saves

**Linux:**
- `~/team-fortress-classic/server.cfg` — Main server configuration  
- `~/team-fortress-classic/config/` — Configuration directory
- `~/team-fortress-classic/logs/` — Log files directory
- `~/team-fortress-classic/data/` — Server data and saves
...
- Check official mod repositories or community sites for Team Fortress Classic
