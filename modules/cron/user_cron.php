...
function exec_ogp_module() 
{
	...
	echo "<h2>" . get_lang("schedule_new_job") . "</h2></br>
        The <i>Cron</i> will run certain actions on your server (Stop, Start, Restart, Update) at specific times. You can either use Actual Times (3:15pm) or relative times since it was 
run last (Every 12 hours).</br>  
Use <a href='http://crontab.guru/#*_*_*_*_*' target='_blank'>Crontab Guru</a> to make sure you have the time formatted correctly. </br> 
You can read more on our <a href='http://wiki.iaregamer.com/doku.php?id=cron' target='_blank'>Wiki</a></br>
<strong><em>VERY IMPORTANT</em> The MINUTE must be set to a number. If you leave it as an * the Job will execute EVERY MINUTE</strong>
<hr/>";
